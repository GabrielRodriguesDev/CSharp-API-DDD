...
namespace Api.Application.Test.Municipio.QuandoRequisitarCreate
{
    public class Retorno_BadRequest
    {
        ...
        public async Task E_Possivel_Invocar_Controller_Create()
        {
            ...
            _controller.ModelState.AddModelError("Error", "Objeto com erro.");

            Mock<IUrlHelper> url = new Mock<IUrlHelper>();
            url.Setup(x => x.Link(It.IsAny<string>(), It.IsAny<string>())).Returns("https://github.com/GabrielRodriguesDev");
